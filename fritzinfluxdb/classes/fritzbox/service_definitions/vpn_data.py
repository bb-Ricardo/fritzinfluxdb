...
lua_services.append({
        ...
        "value_instances": {
            ...
            "vpn_user_virtual_address_ipsec": {
                "data_path": "data.init.userConnections",
                "type": dict,
                "next": {
                    "type": str,
